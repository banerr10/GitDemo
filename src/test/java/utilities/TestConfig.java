...
public class TestConfig {
	...
	public static String from = "rachanabanerjee66@gmail.com";
	public static String password = "HareKrishna@7";
	public static String[] to ={"rachana.banerjee07@gmail.com","abhishek8kar@gmail.com"};
